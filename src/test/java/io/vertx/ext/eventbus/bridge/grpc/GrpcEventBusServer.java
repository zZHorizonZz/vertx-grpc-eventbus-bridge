...
public class GrpcEventBusServer extends AbstractVerticle {
    ...
    public void start(Promise<Void> startPromise) {
        ...
        vertx.eventBus().consumer("echo", msg -> msg.reply(msg.body()));

        // Publish periodic messages to the "news" address
        vertx.setPeriodic(1000, id -> vertx.eventBus().publish("news",
                new JsonObject().put("timestamp", System.currentTimeMillis()).put("message", "News update")
        ));
